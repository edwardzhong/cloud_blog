...
import { View, Text, Navigator, Block, Image } from "@tarojs/components";
...
interface IState {
  post: {
    ...
    lines: Array<{ type: string; text: string; num:number; href:string; src: string; child: Array<{ type: string; text: string; src: string; child:any }> }>;
  };
}
